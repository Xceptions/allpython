    ...
    async function AboutHandler(){
        ...
        fetch('/about/')
            ...
            .then(function(result) {
                ...
                var html_about = '<h2 class="text-4xl items-center justify-center text-center text-gray-500">About</h2>';
                html_about += '<div class="mt-4 mx-auto max-w-screen-sm px-4 sm:px-6 py-24 bg-white text-gray-700" style="border-radius: 2rem;"><div class="text-center">';
        ...
        fetch('/viewjobs/')
            ...
            .then(function(result) {
              // console.log(JSON.stringify(result));
                ...
                html_job += '<h2 class="text-4xl items-center justify-center text-center text-gray-500">Jobs</h2>';
    ...
    async function CompetitionHandler(){
        ...
        fetch('/viewcompetitions/')
            ...
            .then(function(result) {
                ...
                html_comp += '<h2 class="text-4xl items-center justify-center text-center text-gray-500">Competitions</h2>';
                for (let idx in result) {
        ...
        fetch('/learn/')
            ...
            .then(function(result) {
                ...
                for (let idx in result) {
                    ...
                    var inner_temp = "<ul class='list-none'>";
