    ...
    async function AboutHandler(){
        fetch('http://127.0.0.1:8000/about/')
            ...
            .then(function(result) {
                ...
                var html_job = '<div class="mt-4 mx-auto max-w-screen-sm px-4 sm:px-6 py-24 bg-white text-gray-700" style="border-radius: 2rem;"><div class="text-center">';
        ...
        fetch('http://127.0.0.1:8000/viewcompetitions/')
            ...
            .then(function(result) {
                ...
                for (let idx in result) {
                    ...
                    // temp += "<div class='comp_contact_me'>" + comp_posting["contact_me"] + "</div>";
                    // temp += "<div class='date'>" + comp_posting["date"] + "</div>";
                    // temp += "<div class='applied'>" + comp_posting["applied"] + "</div>";
                    temp += "</div>";
                    html_comp += temp;
                };
